...
ARCHLDSCRIPT	:= -T"C:/Intel/intelFPGA_lite18.1/University_Program/Monitor_Program/build/altera-socfpga-unhosted-as.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Files
HDRS		:=
SRCS		:= lab11fig2try2.s pagetable.s
OBJS		:= $(patsubst %, %.o, $(SRCS))

# Targets
COMPILE: lab11fig2try2.srec

lab11fig2try2.srec: lab11fig2try2.axf
	$(RM) $@
	$(OC) $(OCFLAGS) $< $@

lab11fig2try2.axf: $(OBJS)
	$(RM) $@
	$(LD) $(LDFLAGS) $(OBJS) -o $@
...
CLEAN: 
	$(RM) lab11fig2try2.srec lab11fig2try2.axf $(OBJS)
